...
<div class="container">
 ...
 <div class="container">   
	...
	<div class="address col-md-4 col-sm-12 col-xs-12">
		<p><strong>Address: </strong>1-1660 Kenaston Blvd.<br/> Unit 700037, <br/>Winnipeg MB R3P 0X6 Canada</p>
	...
	<div class="contact-form col-md-8 col-sm-12 col-xs-12">
		<form id="contactus" name="contactus" method="post" action="sendmail.php">
			...
			<p><label>Postal Code:* </label><input required type="number" name="post" value="<?php echo $_SESSION['refill']['post']; ?>" id="post" /></p>
			<p><label>Country:* </label><input  required type="text" name="country" value="<?php echo $_SESSION['refill']['country']; ?>" id="country" /></p>
			<p><label>Telephone:* </label><input  required type="number" name="telephone" value="<?php echo $_SESSION['refill']['telephone']; ?>" id="telephone" /></p>
