          ...
          <div class="item">
            ...
            <!-- <div class="item" style="background-image: url(images/slider/bg1.jpg);">
                <div class="slider-inner">
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-6 slider-content">
                                <div class="carousel-content">
                                    <h2><span>Train2Invest</span> is one of the best institutes</h2>
                                    <p>TEACH|TRAIN|COACH</p>
                                    <a class="btn btn-primary btn-lg" href="#get-in-touch">Contact</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="slider-inner">
                    <div class="container">
                        <div class="row">
                          <div class="col-sm-6 slider-content">
                              <div class="carousel-content">
                                  <h2>Train2Invest<span> Join us today</span></h2>
                                  <a class="btn btn-primary btn-lg" href="#portfolio">Course Details</a>
                              </div>
                          </div>
                        </div>
                    </div>
                   ...
                   <div class="container">
                     <div class="support item"  style="background-image: url(images/slider/bg4.jpg);">
                       ...
                       <div class="row">
                         <div class="col-sm-12 col-lg-12 col-md-12 slider-content ">
                             <div class="carousel-content">
                                 <h2>How quickly time flies?</h2>
                                 <h2 class="h2-no-margin">TIME is the CURRENCY of LIFE</h2>
                                 <p class="and-sign">&</p>
                                 <h2 class="h2-no-margin h2-red">PROCRASTINATION is the THIEF of TIME</h2>
                             </div>
                         </div>
                       </div>
                   </div>
              ...
              <div class="col-md-12">
                  <div class="panel panel-default">
                      <div class="panel-body min_height">
                          <div class="col-lg-6">
                            <strong class="strong-logo">TRAIN<strong class="h2-red">2</strong>INVEST</strong><span> is attempting to transform Canadian families in the arena of wealth building and more improtantly wealth management! Think about this:</span>
    ...
    <section id="features">
            <div class="container">
                <div class="section-header">
                    <h2 class="section-title text-center wow fadeInDown animated" style="visibility: visible; animation-name: fadeInDown;">Research & Analysis</h2>
                    <p class="text-center wow fadeInDown animated" style="visibility: visible; animation-name: fadeInDown;">Global Prosperity - Your Inheritance. Learn to invest for yourself!</p>
                </div>


                <div class="row">
                    <div class="col-sm-6 wow fadeInLeft animated" style="visibility: visible; animation-name: fadeInLeft;">
                        <img style="border-radius: 10px;" class="img-responsive" src="images/family.png" alt="">
                    </div>
                    <div class="col-sm-6">
                        <div class="media service-box wow fadeInRight animated" style="visibility: visible; animation-name: fadeInRight;">
                            ...
                            <div class="media-body">
                                <h4 class="media-heading">Research Analysis</h4>
                                <p><label><a href="http://www.train2invest.com/images/research.pdf" target="_blank">Click here for Research &amp; Analysis</a></label>
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="media service-box wow fadeInRight animated" style="visibility: visible; animation-name: fadeInRight;">
                            ...
                            <div class="media-body">
                                <h4 class="media-heading">Check out our testimonials</h4>
                                <p><a href="#testimonal">Testimonals</a></p>
                        ...
                        <div class="media service-box wow fadeInRight animated" style="visibility: visible; animation-name: fadeInRight;">
                            ...
                            <div class="media-body">
                                <h4 style="color:black;">DISCLAIMER</h4>
                                                <p style="color:black;">Email: admin@train2invest.com</p>
...
<!--
      ...
      <div class="container outline-of-course">
          ...
          <!-- /.row -->
                ...
                <!-- <div class="portfolio-item corporate col-md-2">
                    <div class="portfolio-item-inner">
                                    <div class="img-responsive">
                                                <p>
                         Focuses on developing better trading strategies and execution through coaching and mentoring
                        We also provide you with an exceptional list of tools and resources to make your investing decisions easier including:</p>
                        <ul>
                        <li>E-book formatted course manual with updated notes as markets change</li>
                        <li>Free Technical analysis and charting software via the web</li>
                        <li>Breaking Newsletters/Blogs</li>
                        <li>Weekly market update sessions</li>
                        </ul>
                        <p>Most of our education is delivered online in real time through a virtual classroom using 'Go-To Meeting' software. A huge plus for our students is the ability to repeat our classes as many times as they need to within the 6 months. This removes a lot of the anxiety of learning and ensures they can understand and practice what they need to in order to be successful.</p>
                                    </div>
                    </div>
                </div> -->
            </div>
    ...
    <!-- <section id="blog">
        <div class="container">
            <div class="section-header">
                ...
                <p class="text-center wow fadeInDown">Coming Soon</p>
            </div> -->
<!--
            <div class="row">
                <div class="col-sm-6">
    ...
    <section id="animated-number">
        <div class="container">
            ...
            <div class="row text-center">
                ...
                <div class="col-sm-3 col-xs-6">
                    <div class="wow fadeInUp" data-wow-duration="400ms" data-wow-delay="200ms">
                        <div class="animated-number" data-digit="100000" data-duration="1000"></div>
                        <strong>SUCCESSFUL STUDENTS</strong>
                    </div>
                </div>
                <div class="col-sm-3 col-xs-6">
                    <div class="wow fadeInUp" data-wow-duration="400ms" data-wow-delay="300ms">
...
//                 $('#contactus').data('bootstrapValidator').resetForm();
