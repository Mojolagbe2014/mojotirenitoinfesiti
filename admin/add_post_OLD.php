	...
	<div id="content">
		<div class="addpostcontainer">
			...
			<form action="process.php" method="post" name="addpost">
				<p><label>Post Title*</label><input type="text" name="title" required value="" id="title" /></p>
				<p><label>Post Content*</label><textarea name="content" required ></textarea></p>
				<p><input type="submit" name="addpost" value="Add Post" id="addpost" /></p>
			</form>
		</div>
	</div>
