...
<head>
    ...
    <title>Manage Web Pages  - Impact Training &amp; Management Consulting</title>
                                    ...
                                    <table id="webpagelist" class="table table-striped table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Keywords</th>
                                                <th>Actions &nbsp; 
                                                    <button class="btn btn-danger btn-sm multi-delete-webpage multi-select" title="Delete Selected"><i class="btn-icon-only icon-trash"> </i></button>
                                                </th>
                                            </tr>
                                        </thead>
                                        <tbody></tbody>
